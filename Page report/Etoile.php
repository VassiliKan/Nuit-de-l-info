	...
	<script>
		...
		$( function() {
			var rating = new starRating( { // create first star rating system on page load
				...
				starWidth: 40, // width of stars
				starHeight: 40, // height of stars
				ratingPercent: '30%', // percentage star system should start 
...
<body>
	...
	<tr>
		<td>
			<h1>Qualité des vagues </h1>
		</td>
	<!-- first continer element for the first star rating system-->
		<td>
			<div id="star_rating", class="relative" >
			</div>
		</td>
	</tr>
		<td>
			<h1>Qualité du vent </h1>
		</td>
	<!-- second continer element for the first star rating system-->
		<td>
		<div id="star_rating2", class="relative">
		</div>
	</td>
	</tr>
	</table>
